  ...
  return (
    <Modal open={isOpen} footer={null} onCancel={handleCancel}>
      <div className={styles.loginCard}>
        {modeType === 'login' && (
          <LoginModal setModeType={setModeType} handleCancel={handleCancel} />
        )}
        {modeType === 'register' && (
          <RegisterModal setModeType={setModeType} handleCancel={handleCancel} />
        )}
        {modeType === 'forget' && (
          <ForgetModal setModeType={setModeType} handleCancel={handleCancel} />
        )}
      </div>
    </Modal>
  );
